...
import LateAttendancePage from './pages/student/LateAttendancePage.jsx';
...
const StudentPlatform = ({ user, onLogout }) => {
    ...
    return <StudentDashboard user={userData} onLogout={onLogout} onUserDataUpdate={handleUserDataUpdate} />;
};
